...
/*
Plugin Name: 4in44
Plugin URI: http://4in44.com/
Description: Sistem Ahli
Author: 4in44
Version: 1.7.2
Author URI: http://4in44.com/
*/

defined( 'ABSPATH' ) or die( 'Nothing here to see!' );
define('TYPEROCKET_UPDATES', false);
...
final class TypeRocketPlugin
{
    ...
    public function plugins_loaded()
    {
        ...
        require_once plugin_dir_path( __FILE__ ) . 'hooks.php'; //luqman
    ...
    public function activation()
    {
        ...
        flush_rewrite_rules();
        set_transient( 'typerocket-admin-notice' , false );
        require_once plugin_dir_path(__FILE__) . 'database.php'; //luqman
    }
